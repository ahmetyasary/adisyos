...
class KitchenDisplayView extends StatefulWidget {
  const KitchenDisplayView({super.key, this.embedded = false});
              ...
              return TabBar(
                ...
                tabs: [
                  _StatusTab(
                      label: 'Bekliyor',
                      color: _colPending,
                      count: svc.pendingTickets.length),
                  _StatusTab(
                      label: 'Hazırlanıyor',
                      color: _colPreparing,
                      count: svc.preparingTickets.length),
                  _StatusTab(
                      label: 'Hazır',
                      color: _colReady,
                      count: svc.readyTickets.length),
                ],
              );
            }),
        ],
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(CupertinoIcons.trash, size: 16, color: color),
